...
class _VehicleTypeScreenState extends State<VehicleTypeScreen> {
  ...
  getCompanyDriver(String vehicleType) async {
    driverListStrem = FireStoreUtils()
        .getRentalCompanyDriver(widget.rentalOrderModel, vehicleType, rentalOrderModel!.pickupDateTime!,
            rentalOrderModel!.dropDateTime!)
        .asBroadcastStream();
  }
                      ...
                      snapshot.data!.forEach((element) {
                        if (element.rentalBookingDate!.isNotEmpty) {
                          ...
                          print(widget.rentalOrderModel!.pickupDateTime!
                              .toDate()
                              .isAfter(element.rentalBookingDate!.first.toDate()));
                          print(widget.rentalOrderModel!.pickupDateTime!
                              .toDate()
                              .isBefore(element.rentalBookingDate!.last.toDate()));
                          print(widget.rentalOrderModel!.pickupDateTime!
                                  .toDate()
                                  .isAfter(element.rentalBookingDate!.first.toDate()) &&
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: CachedNetworkImage(
                                            ...
                                            imageUrl: driverList[index].carInfo!.carImage!.isEmpty
                                                ? ""
                                                : driverList[index].carInfo!.carImage!.first,
                                            imageBuilder: (context, imageProvider) => Container(
                                              decoration: BoxDecoration(
                                            ...
                                            Expanded(
                                              child: Row(
                                                children: [
                                                  ...
                                                  Icon(Icons.star,
                                                      color: Colors.orange.withOpacity(0.80), size: 16),
                                                  const SizedBox(
                                                    width: 5,
                                                  ),
                                                  Text(
                                                      driverList[index].reviewsCount != 0
                                                          ? (driverList[index].reviewsSum /
                                                                  driverList[index].reviewsCount)
                                                              .toStringAsFixed(1)
                                                          : 0.toString(),
                                                      style: const TextStyle(
                                                        letterSpacing: 0.5,
