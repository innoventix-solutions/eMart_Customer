...
class _DineInRestaurantDetailsScreenState extends State<DineInRestaurantDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    double distanceInMeters = Geolocator.distanceBetween(
        widget.vendorModel.latitude, widget.vendorModel.longitude, position.latitude, position.longitude);
                ...
                Stack(children: [
                  Container(
                      ...
                      decoration: const BoxDecoration(
                        boxShadow: <BoxShadow>[
                          BoxShadow(color: Colors.white38, blurRadius: 25.0, offset: Offset(0.0, 0.75))
                        ],
                      ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                            "In".tr() +
                                                " ${hour.toString().padLeft(2, "0")}h ${minute.toStringAsFixed(0).padLeft(2, "0")}min",
                                            style: const TextStyle())
                                        .tr()
                                  ],
                                ),
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                            width: 1,
                                            color:
                                                isDarkMode(context) ? Color(COLOR_PRIMARY) : Colors.black54)),
                                    child: Icon(
                                          ...
                                          onTap: () {
                                            push(
                                                ...
                                                FullScreenImageViewer(
                                                    imageUrl:
                                                        widget.vendorModel.restaurantMenuPhotos[index]));
                                          },
                                          child: Padding(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                              widget.vendorModel.restaurantCost == 0
                                                  ...
                                                  : "Cost for two".tr() +
                                                      "$symbol${widget.vendorModel.restaurantCost} (Approx)",
                                              style: const TextStyle())
                                          .tr()
                                    ],
                                  ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    launchUrl(createCoordinatesUrl(widget.vendorModel.latitude,
                                        widget.vendorModel.longitude, widget.vendorModel.title));
                                  },
                                    ...
                                    return Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          setState(() {
                                            selectedTimeSlot =
                                                DateFormat('hh:mm a').format(timeSlotList[index]);
                                          });
                                        },
                                        child: Card(
                                          elevation: 5,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    showCustomDialog(
                                        context, userDisFName, userDisLName, userDisPhone, userDisEmail, () {
                                      setState(() {});
                                    });
                                  },
                                  child: Text(
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            dt = DateTime(dt.year, dt.month, dt.day, int.parse(hour.split(":")[0]),
                                int.parse(hour.split(":")[1]), dt.second, dt.millisecond, dt.microsecond);
                            selectedDate = Timestamp.fromDate(dt);
                            FireStoreUtils fireStoreUtils = FireStoreUtils();
                            showProgress(context, 'Sending Table Request...'.tr(), false);
                            VendorModel vendorModel =
                                await fireStoreUtils.getVendorByVendorID(widget.vendorModel.id);
  ...
  void showCustomDialog(BuildContext context, String firstName, String lastName, String phoneNumber,
      String email, VoidCallback? action) {
                        ...
                        ListTile(
                          ...
                          trailing: ConstrainedBox(
                            ...
                            child: TextFormField(
                              ...
                              style: TextStyle(
                                  fontSize: 18, color: isDarkMode(context) ? Colors.white : Colors.black),
  ...
  DateTime stringToDate(String openDineTime) {
    return DateFormat('HH:mm').parse(DateFormat('HH:mm').format(DateFormat("hh:mm a")
        .parse((Intl.getCurrentLocale() == "en_US") ? openDineTime : openDineTime.toLowerCase())));
  }
}
