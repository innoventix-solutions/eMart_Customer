              ...
              child: !_loadMap
                  ...
                  : GoogleMap(
                      initialCameraPosition: CameraPosition(
                        target:
                            widget.displayLocation ?? _currentLocation ?? widget.defaultLocation,
          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(
                    child:
                        Text(widget.localizationItem!.findingPlace, style: TextStyle(fontSize: 16)))
              ],
            ),
          ),
        ),
      ...
      return showCupertinoDialog(
          ...
          builder: (BuildContext ctx) {
            return CupertinoAlertDialog(
              ...
              content:
                  Text("To use location, go to your Settings App > Privacy > Location Services."),
              actions: [
      ...
      return showDialog(
          ...
          builder: (BuildContext ctx) {
            return AlertDialog(
              title: Text("Location is disabled"),
              content:
                  Text("The app needs to access your location. Please enable location service."),
              actions: [
                TextButton(
                  child: Text("Cancel"),
                  onPressed: () async {
